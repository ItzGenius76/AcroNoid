...
module.exports = {
  ...
  run: async (client, interaction) => {
    try {
      ...
      const supportServerLink = "https://discord.gg/2GB3CuVu";
      const githubLink = "https://g";
      const replitLink = "https://re";
      const youtubeLink = "https://www.yout";
        const embed = new EmbedBuilder()
            ...
            .setAuthor({
              ...
              url: 'https://https://discord.gg/2GB3CuVu'
          })
